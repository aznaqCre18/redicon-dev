...
const HorizontalNavGroup = (props: Props) => {
  ...
  return (
    <CanViewNavGroup navGroup={item}>
      ...
      >
        <ChildWrapper>
          <List component='div' sx={{ py: skin === 'bordered' ? 2.625 : 2.75, padding: 0 }}>
            <ListItem
              aria-haspopup='true'
            ...
            >
              ...
              >
                ...
                >
                  <ListItemIcon sx={{ mr: 1, color: menuOpen ? 'text.primary' : 'text.secondary' }}>
                    <UserIcon
                      icon={icon}
            ...
            >
              <Box
                ...
                sx={{
                  ...
                  ml: childMenuGroupStyles() === 'left' ? (skin === 'bordered' ? 0 : -1) : 0,
                  mr: childMenuGroupStyles() === 'right' ? (skin === 'bordered' ? 0 : -1) : 0,
                  pl: childMenuGroupStyles() === 'left' ? (skin === 'bordered' ? 0 : 0) : 0,
                  pr: childMenuGroupStyles() === 'right' ? (skin === 'bordered' ? 0 : 0) : 0,
                  ...(hasParent
                    ? { position: 'fixed !important' }
                    : { pt: skin === 'bordered' ? 3.25 : 3 })
                }}
              >
                <NavigationMenu
                  sx={{
