...
type ThemeCustomizerDrawerProps = {
  open: boolean
  onClose: () => void
}

export const ThemeCustomizerDrawer = ({ open, onClose }: ThemeCustomizerDrawerProps) => {
  // ** State
  // const [open, setOpen] = useState<boolean>(false)
      ...
      <PerfectScrollbar options={{ wheelPropagation: false }}>
        <CustomizerSpacing className='customizer-body'>
          ...
          <div>
            ...
            <Box sx={{ display: 'flex' }}>
              <ColorBox
                onClick={() => handleChange('themeColor', 'violet')}
                sx={{
              ...
              {[
                ...
                return (
                  <IconButton
                    ...
                    sx={{
                      color: displayFont === size ? 'primary.main' : 'text.secondary',
                      height: 40,
                      width: 40,
                      borderRadius: '50%',
                      fontSize: '.9rem'
                  ...
                  >
                    {/* <Icon icon='tabler:letter-a' fontSize={20} /> */}
                    {text}
                  </IconButton>
                )
              })}
