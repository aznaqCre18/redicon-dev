...
const StockOpnameItem = ({ index, products, product, setStockOpname }: props) => {
  ...
  }, [getUnit, price, recordStock, product, unit])

  return (
    <Grid item borderRadius={1} container alignItems={'center'} columns={11} columnSpacing={3}>
              ...
              if (dataProductBySku && isSkuAvailable) {
                ...
                if (data.data.data && data.data.data.length > 0) {
                  ...
                  setStockOpname({
                    ...
                    remark: '',
                    total: discount,
                    price: value.variants ? 0 : value.product.price[1],
                  ...
                  onChange={value => {
                    if (value) {
                      ...
                      setStockOpname({
                        ...product,
                        price: value,
                        total: value * (product.quantity ?? 0)
                      })
                    } else {
                      setPrice(0)
                      setStockOpname({
