...
import StockOpnameItem, { StockOpanameType } from './components/StockOpnameItem'
...
const AddInvoice = () => {
  ...
  const [fromOutlet, setFromOutlet] = useState<number | undefined>(undefined)
  const [toOutlet, setToOutlet] = useState<number | undefined>(undefined)
          ...
          <Grid item xs={12}>
            <Grid container spacing={2} columns={18}>
              <Grid item xs={12} sm={3}>
                <PickerDate
                  label={t('Transfer Date') ?? 'Transfer Date'}
                  onSelectDate={date => {
                    setDateValue(date)
                  }}
                  value={dateValue}
