          ...
          <Grid item xs={12}>
            <Grid container spacing={2} columns={18}>
              <Grid item xs={12} sm={3}>
                <PickerDate
                  label={t('Opname Date') ?? 'Opname Date'}
                  onSelectDate={date => {
                    setDateValue(date)
                  }}
                  value={dateValue}
              ...
              <Grid item xs={12} sm={3}>
                <PickerDate
                  ...
                  value={dateValue}
                  onSelectDate={(date: Date) => setDateValue(date)}
                />
              </Grid>
              <Grid item xs={12} sm={3}>
                {!getOutlet.isLoading && (
                ...
                <Controller
                  ...
                  render={({ field: { value, ...field } }) => (
                    <TextField
                      ...
                      label={t('Stock Opname ID')}
                    />
                  )}
                />
              </Grid>
              <Grid item xs={12} sm={3}>
                <TextField label={t('Responsible By')} size='small' />
              </Grid>
              <Grid item xs={12} sm={3}>
                <TextField label={t('Remark')} size='small' />
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={12}>
