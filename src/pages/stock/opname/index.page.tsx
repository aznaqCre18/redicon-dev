...
const StockOpnamePage = () => {
  ...
  const columns: GridColDef<StockOpnameType>[] = [
    ...
    },
    {
      flex: 1,
      field: 'date2',
      headerName: t('Adjustment Date') ?? 'Adjustment Date',
      renderCell: params => (
        <Typography variant='body2' sx={{ color: 'text.primary' }}>
          {params.value}
        </Typography>
    ...
    },
    {
      flex: 1,
      field: 'customerName',
      headerName: t('Responsible By') ?? 'Responsible By',
      renderCell: params => (
        <Typography variant='body2' sx={{ color: 'text.primary' }}>
          {params.value}
        </Typography>
...

    {
      flex: 1,
      field: 'customerName2',
      headerName: t('Process By') ?? 'Process By',
      renderCell: params => (
        <Typography variant='body2' sx={{ color: 'text.primary' }}>
          {params.value}
        </Typography>
    ...
    },
    {
      ...
      renderCell: params => {
        return (
          ...
          >
            {checkPermission('stock opname.update') && (
            ...
            {checkPermission('stock opname.delete') && (
