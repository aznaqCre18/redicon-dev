    ...
    <Box>
      <Grid container columnSpacing={2}>
        ...
        >
          ...
          <CustomTextField label='Nama' defaultValue={'Ambil Sendiri'} fullWidth />
          <TextFieldNumber
            prefix='Rp '
            InputProps={{
              inputProps: {
          ...
          <div>
            <InputLabel>Aktifkan Ambil Sendiri:</InputLabel>
...
export default AmbilSendiriTab
